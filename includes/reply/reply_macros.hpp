...
/* checkCommandArgument been granted permission to speak on a moderated */
...
/* RPL_YOUREOPER is sent back to a client which checkCommandArgument */
...
/* a TRACE message and checkCommandArgument to pass it on to another */
