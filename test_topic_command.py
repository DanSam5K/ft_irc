...
def client1():
    """First client: channel operator who will set topic"""
    ...
    # Set channel topic
    sock.send(b"TOPIC #test :This is a test topic\r\n")
    time.sleep(0.1)
...
def client2():
    """Second client: will see topic change"""
    sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    sock.connect(('127.0.0.1', 6667))
...
def main():
    print("Starting TOPIC command test...")
    ...
    print("TOPIC command test completed!")
