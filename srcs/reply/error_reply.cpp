...
// std::string const rpl_msg::errNoSuchNick(ClientUser &user,
...
// std::string const rpl_msg::errNoSuchChannel(ClientUser &user,
...
// /* that channel. */
// std::string const rpl_msg::errCannotSendToChan(ClientUser &user,
//         std::string channelName)
// {
// 	std::string reply = SERVER_PREFIX " ";
// 	reply += ERR_CANNOTSENDTOCHAN " ";
...
// /* another channel. */
// std::string const rpl_msg::errTooManyChannels(ClientUser &user,
//         std::string channelName)
// {
// 	std::string reply = SERVER_PREFIX " ";
// 	reply += ERR_TOOMANYCHANNELS " ";
...
// /*   such channel. */
// std::string const rpl_msg::errTooManyTargets(ClientUser &user, std::string modeTarget,
//         int error_code,
...
// std::string const rpl_msg::errNoSuchService(ClientUser &user,
...
// std::string const rpl_msg::errFileError(ClientUser &user, std::string file_operation,
//                                       std::string filename)
// {
// 	std::string reply = SERVER_PREFIX " ";
// 	reply += ERR_FILEERROR " ";
...
// /*   mechanism. */
// std::string const rpl_msg::errUnavailResource(ClientUser &user,
...
// std::string const rpl_msg::errUserNotInChannel(ClientUser &user, std::string nickname,
//         std::string channel)
// {
// 	std::string reply = SERVER_PREFIX " ";
// 	reply += ERR_USERNOTINCHANNEL " ";
...
// std::string const rpl_msg::errUserOnChannel(ClientUser &user, std::string username,
//         std::string channel)
// {
// 	std::string reply = SERVER_PREFIX " ";
// 	reply += ERR_USERONCHANNEL " ";
...
// std::string const rpl_msg::errUnknownMode(ClientUser &user, std::string channel,
//                                         char modechar)
// {
// 	std::string reply = SERVER_PREFIX " ";
// 	reply += ERR_UNKNOWNMODE " ";
...
// std::string const rpl_msg::errBanListFull(ClientUser &user, std::string channel,
//                                         std::string modechar)
// {
// 	std::string reply = SERVER_PREFIX " ";
// 	reply += ERR_BANLISTFULL " ";
